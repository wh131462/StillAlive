...
pub const STATIC_CIPHER_BOX: [u8; 256] = [
...
impl StaticCipher {
    pub fn get_mask(offset: usize) -> u8 {
        let mut offset = offset;
        if offset > 0x7FFF {
            offset %= 0x7FFF;
        }
        let idx = (offset * offset + 27) & 0xff;
        STATIC_CIPHER_BOX[idx]
    }
}

impl super::super::Decrypter for StaticCipher {
