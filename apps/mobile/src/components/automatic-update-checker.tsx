...
import { ANDROID_UPDATE_SOURCES, checkForAndroidUpdate, type AndroidUpdateManifest } from '../update/android-update';
...
export function AutomaticUpdateChecker() {
  ...
  useEffect(() => {
    if (checked.current || !ANDROID_UPDATE_SOURCES.length) return;
