...
const styles = createThemedStyles(() => ({
  screen: { flex: 1, backgroundColor: colors.paper }, headerSafeArea: { backgroundColor: colors.paper }, disabled: { opacity: 0.45 }, albumStrip: { flexGrow: 0, height: 64 }, albumRow: { gap: spacing.xs, paddingHorizontal: spacing.md, paddingVertical: spacing.sm }, limitedNotice: { marginHorizontal: spacing.md, marginBottom: spacing.xs, padding: spacing.sm, borderRadius: radius.sm, backgroundColor: colors.lifeLight }, limitedText: { color: colors.lifeDeep, fontSize: typography.size.meta, fontWeight: '700', textAlign: 'center' }, albumChip: { flexShrink: 0, paddingHorizontal: spacing.md, paddingVertical: 8, borderRadius: 18, backgroundColor: colors.sheet }, albumChipActive: { backgroundColor: colors.lifeLight }, albumChipText: { color: colors.inkSoft, fontSize: typography.size.caption }, albumChipTextActive: { color: colors.lifeDeep, fontWeight: '800' }, grid: { padding: spacing.xs, paddingBottom: 24 }, gridRow: { gap: spacing.xs }, tile: { aspectRatio: 1, marginBottom: spacing.xs, position: 'relative', overflow: 'hidden', borderRadius: radius.sm, backgroundColor: colors.sheet }, tileImage: { width: '100%', height: '100%' }, check: { position: 'absolute', top: 7, right: 7, width: 25, height: 25, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: colors.onLife, borderRadius: 13, backgroundColor: 'rgba(0,0,0,0.28)' }, checkSelected: { backgroundColor: colors.life, borderColor: colors.life }, checkText: { color: colors.onLife, fontSize: 13, fontWeight: '900' }, videoBadge: { position: 'absolute', left: 7, bottom: 7, paddingHorizontal: 6, paddingVertical: 3, borderRadius: 8, backgroundColor: 'rgba(0,0,0,0.62)' }, videoText: { color: colors.onLife, fontSize: 10, fontWeight: '700' }, center: { flex: 1, minHeight: 300, alignItems: 'center', justifyContent: 'center', padding: spacing.lg }, message: { marginTop: spacing.sm, color: colors.inkSoft, fontSize: typography.size.body, textAlign: 'center' }, fallbackButton: { marginTop: spacing.md, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, borderRadius: 18, backgroundColor: colors.life }, fallbackText: { color: colors.onLife, fontWeight: '800' }, footer: { paddingVertical: spacing.lg }, previewBackdrop: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.94)' }, previewMedia: { width: '100%', height: '78%' }, previewHint: { position: 'absolute', bottom: 42, color: 'rgba(255,255,255,0.82)', fontSize: typography.size.caption },
}));
