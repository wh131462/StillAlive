...
const styles = createThemedStyles(() => ({
  ...
  birthdayCard: { marginTop: spacing.lg, padding: spacing.md, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.line, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  backupPrimary: { minWidth: 88, minHeight: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  audioPreview: { minHeight: 58, padding: spacing.sm, flexDirection: 'row', alignItems: 'center', borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  onboardingInput: { minHeight: 50, marginTop: spacing.md, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 14 },
  ...
  onboardingSegmented: { flexDirection: 'row', padding: 3, borderRadius: 6, backgroundColor: colors.paper },
  onboardingSegment: { flex: 1, minHeight: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
  ...
  onboardingButton: { minHeight: 50, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
