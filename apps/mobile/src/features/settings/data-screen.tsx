      ...
      <View>
        ...
        <View style={styles.heatmapRow}>
          ...
          <View style={styles.heatmapGrid}>
            {weeks.map((week, weekIndex) => <View key={weekIndex} style={styles.heatmapWeek}>{week.map((cell) => <View key={cell.dayKey} style={[styles.heatmapCell, { backgroundColor: activityCellColor(cell.count) }, cell.isFuture && styles.heatmapCellFuture]} />)}</View>)}
          </View>
        </View>
      </View>
    </ScrollView>
