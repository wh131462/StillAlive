...
const styles = createThemedStyles(() => ({
  ...
  appearanceGroup: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, appearanceSection: { padding: spacing.md }, appearanceTitle: { color: colors.ink, fontSize: 13, fontWeight: '700' }, themeOptions: { marginTop: spacing.md, flexDirection: 'row', gap: spacing.sm }, themeOption: { flex: 1, minWidth: 0, minHeight: 112, padding: spacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6 }, themeOptionSelected: { borderColor: colors.life, backgroundColor: colors.lifeLight }, themePreview: { height: 56, padding: 6, justifyContent: 'flex-end', overflow: 'hidden', borderRadius: 6 }, themePreviewSheet: { height: 29, padding: 5, justifyContent: 'flex-end', borderTopRightRadius: 9, borderBottomLeftRadius: 9 }, themePreviewAccent: { width: '58%', height: 5, borderRadius: 3 }, themeOptionMeta: { minHeight: 22, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, themeLabel: { flex: 1, marginTop: 5, color: colors.inkSoft, fontSize: 12, fontWeight: '600' }, themeLabelSelected: { color: colors.life }, themeHint: { marginTop: 1, color: colors.inkFaint, fontSize: 10, lineHeight: 13 }, selectionMark: { width: 18, height: 18, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: colors.life },
  nameStylePreviewRow: { minHeight: 82, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center' }, nameStylePreviewCopy: { minWidth: 0, flex: 1 }, nameStylePreviewLabel: { color: colors.inkSoft, fontSize: 12, fontWeight: '700' }, nameStylePreviewValue: { maxWidth: '100%', marginTop: 6, paddingBottom: 3, fontSize: 17, lineHeight: 28 }, nameStylePreviewMeta: { marginTop: 4, color: colors.inkFaint, fontSize: typography.size.meta }, nameStyleAction: { minHeight: 36, marginLeft: spacing.sm, paddingHorizontal: spacing.sm, flexDirection: 'row', gap: 3, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: colors.lifeLight }, nameStyleActionText: { color: colors.life, fontSize: typography.size.meta, fontWeight: '800' }, nameStyleModalBackdrop: { flex: 1, padding: spacing.lg, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.backdrop }, nameStyleModalCard: { width: '100%', maxWidth: 420, overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, nameStyleModalHeader: { minHeight: 68, paddingHorizontal: spacing.lg, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, nameStyleModalCopy: { minWidth: 0, flex: 1 }, sheetEyebrow: { color: colors.life, fontFamily: typography.mono, fontSize: typography.size.meta, letterSpacing: 1.2 }, sheetTitle: { marginTop: 3, color: colors.ink, fontFamily: typography.display, fontSize: 21 }, nameStyleClose: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: colors.lifeLight }, nameStyleSample: { minHeight: 72, marginHorizontal: spacing.lg, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 6, backgroundColor: colors.paper }, nameStyleSampleLabel: { color: colors.inkFaint, fontFamily: typography.mono, fontSize: typography.size.meta }, nameStyleSampleValue: { maxWidth: '68%', fontSize: 18, textAlign: 'right' }, nameStyleCarousel: { minHeight: 148, marginTop: spacing.md, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.lineSoft, backgroundColor: colors.paper }, nameStyleCarouselList: { width: '100%', minHeight: 126 }, nameStyleCarouselPage: { minHeight: 126, padding: spacing.md, alignItems: 'center', justifyContent: 'center' }, nameStyleCarouselCard: { width: '100%', minHeight: 98, alignItems: 'center', justifyContent: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight }, nameStyleCarouselValue: { maxWidth: '90%', fontSize: 22, textAlign: 'center' }, nameStyleCarouselLabel: { marginTop: 7, color: colors.life, fontSize: typography.size.body, fontWeight: '800' }, nameStyleCarouselHint: { marginTop: 3, color: colors.inkSoft, fontSize: typography.size.meta }, nameStyleDots: { minHeight: 18, flexDirection: 'row', gap: spacing.xs, alignItems: 'center', justifyContent: 'center' }, nameStyleDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: colors.line }, nameStyleDotActive: { width: 16, backgroundColor: colors.life }, nameStyleDone: { minHeight: 44, margin: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life }, nameStyleDoneText: { color: colors.onLife, fontSize: typography.size.caption, fontWeight: '800' },
  group: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, separator: { height: StyleSheet.hairlineWidth, marginLeft: spacing.md, backgroundColor: colors.line }, entry: { minHeight: 72, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center' }, entryCompact: { minHeight: 64 }, entryIcon: { width: 38, height: 38, marginRight: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 19, backgroundColor: colors.lifeLight }, entryCopy: { flex: 1 }, entryTitle: { color: colors.ink, fontSize: 13, fontWeight: '600' }, entryHint: { marginTop: 5, color: colors.inkFaint, fontSize: typography.size.meta, lineHeight: 15 },
  ...
  inlineButton: { minHeight: 44, marginTop: spacing.sm, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.sheet }, inlineButtonText: { color: colors.life, fontSize: typography.size.caption, fontWeight: '700' }, error: { marginTop: spacing.sm, color: colors.danger, fontSize: typography.size.meta, lineHeight: 17 },
