...
const styles = createThemedStyles(() => ({
  ...
  sleepTimerActive: { paddingHorizontal: spacing.sm, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  moreMenu: { position: 'absolute', zIndex: 6, minWidth: 170, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.line, borderRadius: 6, backgroundColor: colors.sheet, shadowColor: '#000', shadowOpacity: 0.16, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 8 },
  ...
  error: { width: '100%', minHeight: 42, marginTop: spacing.sm, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 6, backgroundColor: colors.dangerLight },
  ...
  emptyPrimary: { minHeight: 44, paddingHorizontal: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  emptyPrimaryText: { color: colors.onLife, fontSize: 11, fontWeight: '700' },
  emptySecondary: { minHeight: 44, paddingHorizontal: spacing.lg, alignItems: 'center', justifyContent: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6 },
  ...
  sources: { marginTop: spacing.sm, padding: 3, flexDirection: 'row', borderRadius: 6, backgroundColor: colors.paper },
  source: { flex: 1, minHeight: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
  ...
  queueCover: { marginRight: spacing.sm, borderRadius: 6 },
