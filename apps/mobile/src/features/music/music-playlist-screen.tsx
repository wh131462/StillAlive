...
const styles = createThemedStyles(() => ({
  ...
  playAll: { flex: 1, minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderRadius: 6, backgroundColor: colors.life },
  playAllText: { color: colors.onLife, fontSize: 12, fontWeight: '700' },
  shuffle: { flex: 1, minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  emptyAction: { minWidth: 148, minHeight: 46, marginTop: spacing.lg, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  importButton: { minHeight: 48, marginTop: spacing.sm, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  pickerCover: { marginLeft: spacing.xs, borderRadius: 6 },
  ...
  confirmButton: { minHeight: 50, marginTop: spacing.sm, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  actionPlaylistHeader: { minHeight: 88, marginBottom: spacing.sm, padding: spacing.md, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.paper },
  ...
  metadataButton: { minHeight: 44, marginTop: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  editInput: { minHeight: 52, marginTop: spacing.sm, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 14 },
  qualityPicker: { marginTop: spacing.sm, flexDirection: 'row', gap: spacing.sm },
  qualityOption: { minWidth: 72, minHeight: 40, paddingHorizontal: spacing.md, alignItems: 'center', justifyContent: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.paper },
