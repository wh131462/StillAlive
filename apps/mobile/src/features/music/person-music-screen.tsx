...
const styles = createThemedStyles(() => ({
  ...
  importButton: { minHeight: 52, marginTop: spacing.md, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  musicChoiceCover: { borderRadius: 6 },
