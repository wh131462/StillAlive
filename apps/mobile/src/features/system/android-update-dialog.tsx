...
const styles = createThemedStyles(() => ({
  ...
  primaryButton: { minHeight: 50, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  primaryButtonText: { color: colors.onLife, fontSize: typography.size.label, fontWeight: '700' },
  secondaryButton: { minHeight: 42, marginTop: spacing.xs, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
