...
const styles = createThemedStyles(() => ({
  ...
  aboutCard: { padding: spacing.lg, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  links: { marginTop: spacing.md, overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet },
