...
const styles = createThemedStyles(() => ({
  ...
  hero: { minHeight: 116, padding: spacing.lg, flexDirection: 'row', alignItems: 'center', overflow: 'hidden', borderRadius: 6, backgroundColor: colors.codeBackground }, heroIcon: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: colors.life }, heroCopy: { flex: 1, marginLeft: spacing.md }, eyebrow: { color: colors.onLifeMuted, fontFamily: typography.mono, fontSize: typography.size.meta, letterSpacing: 1.2 }, title: { marginTop: spacing.xs, color: colors.codeForeground, fontFamily: typography.display, fontSize: 25 }, subtitle: { marginTop: spacing.xs, color: colors.onLifeMuted, fontSize: typography.size.meta }, liveBadge: { position: 'absolute', top: spacing.md, right: spacing.md, flexDirection: 'row', alignItems: 'center', gap: 5 }, liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.sun }, liveText: { color: colors.sun, fontFamily: typography.mono, fontSize: 9, letterSpacing: 1 },
  sectionHeading: { marginTop: spacing.xl, marginBottom: spacing.sm, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' }, sectionEyebrow: { color: colors.life, fontFamily: typography.mono, fontSize: typography.size.meta, letterSpacing: 1.2 }, sectionTitle: { marginTop: 3, color: colors.ink, fontFamily: typography.display, fontSize: 22 }, sectionAction: { color: colors.life, fontFamily: typography.mono, fontSize: typography.size.meta }, runtimeCard: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, healthCard: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, countGrid: { padding: spacing.md, flexDirection: 'row', justifyContent: 'space-between' }, metric: { minWidth: '22%', alignItems: 'center' }, metricValue: { color: colors.life, fontFamily: typography.mono, fontSize: 20, fontWeight: '700' }, metricSuffix: { fontSize: 10, fontWeight: '500' }, metricLabel: { marginTop: 4, color: colors.inkFaint, fontSize: typography.size.meta }, performanceHint: { paddingHorizontal: spacing.md, paddingBottom: spacing.md, color: colors.inkFaint, fontSize: typography.size.meta, lineHeight: 16 },
  ...
  inlineActions: { minHeight: 58, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: spacing.sm }, actionButton: { minHeight: 36, paddingHorizontal: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.lifeLight }, actionButtonText: { color: colors.life, fontSize: typography.size.meta, fontWeight: '700' }, actionButtonDanger: { backgroundColor: colors.dangerLight }, actionButtonDangerText: { color: colors.danger, fontSize: typography.size.meta, fontWeight: '700' }, updateRow: { minHeight: 72, padding: spacing.md, flexDirection: 'row', alignItems: 'center' },
  toolGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }, toolButton: { width: '48%', minHeight: 112, padding: spacing.md, borderRadius: 6, backgroundColor: colors.sheet }, toolButtonPrimary: { backgroundColor: colors.life }, toolIcon: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: colors.lifeLight }, toolIconPrimary: { backgroundColor: colors.lifeDeep }, toolTitle: { marginTop: spacing.sm, color: colors.ink, fontSize: typography.size.caption, fontWeight: '700' }, toolTitlePrimary: { color: colors.onLife }, toolHint: { marginTop: 3, color: colors.inkFaint, fontSize: typography.size.meta }, toolHintPrimary: { color: colors.onLifeMuted },
  logCard: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet }, logCopy: { flex: 1 }, logTitle: { color: colors.ink, fontFamily: typography.mono, fontSize: typography.size.meta }, logHint: { marginTop: 4, color: colors.inkFaint, fontSize: typography.size.meta }, filterRow: { padding: spacing.sm, flexDirection: 'row', gap: spacing.xs }, filter: { paddingHorizontal: spacing.sm, paddingVertical: 6, borderRadius: 6 }, filterSelected: { backgroundColor: colors.lifeLight }, filterText: { color: colors.inkFaint, fontFamily: typography.mono, fontSize: 9 }, filterTextSelected: { color: colors.life }, logViewer: { minHeight: 150, padding: spacing.md, backgroundColor: colors.codeBackground }, logLine: { marginBottom: 6, color: colors.codeForeground, fontFamily: typography.mono, fontSize: 9, lineHeight: 14 }, emptyText: { color: colors.onLifeMuted, fontFamily: typography.mono, fontSize: typography.size.meta }, logActions: { minHeight: 50, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, logAction: { minHeight: 40, paddingHorizontal: spacing.sm, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 6 }, logActionText: { color: colors.life, fontSize: typography.size.caption, fontWeight: '700' }, logActionDangerText: { color: colors.danger, fontSize: typography.size.caption, fontWeight: '700' },
