...
const styles = createThemedStyles(() => ({
  ...
  dangerCard: { marginTop: spacing.md, padding: spacing.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.dangerLine, borderRadius: 6, backgroundColor: colors.dangerLight },
  ...
  input: { minHeight: 50, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.dangerLine, borderRadius: 6, color: colors.ink, backgroundColor: colors.paper, fontSize: typography.size.body },
  deleteButton: { minHeight: 50, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.danger },
