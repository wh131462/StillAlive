...
const styles = createThemedStyles(() => ({
  ...
  selector: { minHeight: 52, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  customInput: { flex: 1, minHeight: 48, paddingHorizontal: spacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet, color: colors.ink, fontSize: 14 },
  applyButton: { width: 68, minHeight: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
