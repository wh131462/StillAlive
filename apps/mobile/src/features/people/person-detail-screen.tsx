...
const styles = createThemedStyles(() => ({
  ...
  identityCard: { padding: spacing.lg, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  profileCard: { paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  importantDateCard: { paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  privateToggle: { minHeight: 44, marginTop: spacing.sm, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  featureCard: { overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  emptyCard: { marginTop: spacing.lg, padding: spacing.lg, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  eventCard: { marginTop: spacing.md, padding: spacing.md, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  mergeConfirm: { minHeight: 50, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  moreMenu: { position: 'absolute', minWidth: 180, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.line, borderRadius: 6, backgroundColor: colors.sheet, shadowColor: '#000', shadowOpacity: 0.16, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 8 },
