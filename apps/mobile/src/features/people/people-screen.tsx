...
const styles = createThemedStyles(() => ({
  ...
  searchField: { height: 50, paddingLeft: spacing.md, paddingRight: 6, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  emptyCard: { marginTop: 0, padding: spacing.lg, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  list: { marginTop: 0, paddingHorizontal: spacing.md, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  input: { height: 54, marginTop: spacing.lg, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 16 },
  confirmButton: { height: 52, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
