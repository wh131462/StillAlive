...
const styles = createThemedStyles(() => ({
  flex: { flex: 1 }, safeArea: { flex: 1, backgroundColor: colors.paper }, content: { padding: spacing.lg, paddingBottom: spacing.xxl }, grid: { marginTop: spacing.lg, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: spacing.lg }, album: { width: '48%' }, cover: { width: '100%', aspectRatio: 1, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', backgroundColor: colors.lifeLight }, coverImage: { width: '100%', height: '100%' }, coverPlaceholder: { alignItems: 'center', gap: 6 }, coverEmpty: { color: colors.inkFaint, fontSize: 8 }, albumCopy: { paddingTop: spacing.sm }, albumName: { color: colors.ink, fontFamily: typography.display, fontSize: 16 }, albumMeta: { marginTop: 4, color: colors.inkFaint, fontSize: 8 }, sortOverlay: { position: 'absolute', right: spacing.sm, bottom: spacing.sm, height: 38, flexDirection: 'row', alignItems: 'center', overflow: 'hidden', borderRadius: 19, backgroundColor: colors.sheet }, sortButton: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center' }, sortDivider: { width: StyleSheet.hairlineWidth, height: 18, backgroundColor: colors.line }, disabled: { opacity: 0.3 }, pressed: { opacity: 0.72 }, empty: { marginTop: spacing.lg, padding: spacing.xl, alignItems: 'center', borderRadius: 6, backgroundColor: colors.sheet }, emptyIcon: { width: 56, height: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 28, backgroundColor: colors.lifeLight }, emptyTitle: { marginTop: spacing.md, color: colors.ink, fontFamily: typography.display, fontSize: 19 }, emptyText: { marginTop: spacing.sm, color: colors.inkFaint, fontSize: 10, lineHeight: 18, textAlign: 'center' }, emptyAction: { marginTop: spacing.lg, color: colors.life, fontSize: 11, fontWeight: '700' }, backdrop: { flex: 1, justifyContent: 'flex-end', backgroundColor: colors.backdrop }, sheet: { padding: spacing.lg, paddingBottom: spacing.xxl, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, backgroundColor: colors.paper }, handle: { width: 36, height: 4, marginBottom: spacing.lg, alignSelf: 'center', borderRadius: 2, backgroundColor: colors.line }, sheetTitle: { color: colors.ink, fontFamily: typography.display, fontSize: 22 }, input: { minHeight: 52, marginTop: spacing.lg, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.sheet, color: colors.ink }, confirm: { minHeight: 52, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life }, confirmText: { color: colors.onLife, fontSize: 11, fontWeight: '700' }, missing: { margin: spacing.lg, color: colors.inkSoft, fontSize: 16 },
}));
