...
const styles = createThemedStyles(() => ({
  ...
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs }, photoCard: { width: '32.4%', overflow: 'hidden', backgroundColor: colors.sheet }, photoPressable: { width: '100%' }, photoPressed: { opacity: 0.76, transform: [{ scale: 0.97 }] }, photo: { width: '100%', aspectRatio: 1, backgroundColor: colors.lifeLight }, coverBadge: { position: 'absolute', top: 6, left: 6, paddingHorizontal: 7, paddingVertical: 4, borderRadius: 10, backgroundColor: colors.life }, coverBadgeText: { color: colors.onLife, fontSize: 8, fontWeight: '700' }, disabled: { opacity: 0.3 },
  empty: { marginTop: spacing.lg, padding: spacing.xl, alignItems: 'center', borderRadius: 6, backgroundColor: colors.sheet }, emptyIcon: { width: 56, height: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 28, backgroundColor: colors.lifeLight }, emptyTitle: { marginTop: spacing.md, color: colors.ink, fontFamily: typography.display, fontSize: 20 }, emptyText: { marginTop: spacing.sm, color: colors.inkFaint, fontSize: 10, lineHeight: 18, textAlign: 'center' }, emptyAction: { marginTop: spacing.lg, color: colors.life, fontSize: 11, fontWeight: '700' }, backdrop: { flex: 1, justifyContent: 'flex-end', backgroundColor: colors.backdrop }, sourceSheet: { padding: spacing.lg, paddingBottom: spacing.xl, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, backgroundColor: colors.paper }, sourceOption: { minHeight: 60, alignItems: 'center', justifyContent: 'center', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.line }, sourceOptionText: { color: colors.ink, fontSize: 15, fontWeight: '600' }, sheet: { padding: spacing.lg, paddingBottom: spacing.xxl, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, backgroundColor: colors.paper }, actionSheet: { padding: spacing.lg, paddingBottom: spacing.xxl, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, backgroundColor: colors.paper }, handle: { width: 36, height: 4, marginBottom: spacing.lg, alignSelf: 'center', borderRadius: 2, backgroundColor: colors.line }, actionPreview: { marginBottom: spacing.sm, flexDirection: 'row', alignItems: 'center' }, albumActionIcon: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.lifeLight }, actionThumb: { width: 52, height: 52, overflow: 'hidden', borderRadius: 6, backgroundColor: colors.lifeLight }, actionCopy: { flex: 1, marginLeft: spacing.md }, actionTitle: { color: colors.ink, fontFamily: typography.display, fontSize: 20 }, actionMeta: { marginTop: 3, color: colors.inkFaint, fontSize: 9 }, actionRow: { minHeight: 52, paddingHorizontal: spacing.sm, flexDirection: 'row', alignItems: 'center', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.line }, actionRowPressed: { backgroundColor: colors.sheet }, actionRowText: { flex: 1, marginLeft: spacing.md, fontSize: 12 }, actionCancel: { minHeight: 50, marginTop: spacing.sm, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.sheet }, actionCancelText: { color: colors.inkSoft, fontSize: 12, fontWeight: '700' }, sheetTitle: { color: colors.ink, fontFamily: typography.display, fontSize: 22 }, input: { minHeight: 52, marginTop: spacing.lg, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.sheet, color: colors.ink }, confirm: { minHeight: 52, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life }, confirmText: { color: colors.onLife, fontSize: 11, fontWeight: '700' }, missing: { margin: spacing.lg, color: colors.inkSoft, fontSize: 16 },
}));
