...
const styles = createThemedStyles(() => ({
  ...
  sourceCancel: { minHeight: 54, marginTop: spacing.sm, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.paper },
  ...
  sectionIndex: { width: 30, height: 24, paddingTop: 0, borderRadius: 6, backgroundColor: colors.lifeLight, color: colors.life, fontFamily: typography.mono, fontSize: typography.size.meta, letterSpacing: 1, lineHeight: 24, textAlign: 'center', textAlignVertical: 'center' },
  sectionCopy: { flex: 1 },
  ...
  input: { minHeight: 52, paddingHorizontal: spacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet, color: colors.ink, fontSize: 15 },
  contactItem: { marginTop: spacing.sm },
  contactRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  contactType: { width: 112, minHeight: 52, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  contactTypeMenu: { marginTop: spacing.sm, padding: spacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  contactTypeCustomInput: { minHeight: 44, marginTop: spacing.md, paddingHorizontal: spacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 13 },
  customFieldList: { marginTop: spacing.md, overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  importantDateList: { marginTop: spacing.md, overflow: 'hidden', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  importantDateListAction: { width: 36, height: 40, marginLeft: spacing.xs, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
  ...
  dateAddButton: { minHeight: 48, marginTop: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  importantDateSaveButton: { minHeight: 50, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  reminderCard: { marginTop: spacing.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.md, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  reminderAction: { marginTop: spacing.sm, minHeight: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  inlineInput: { flex: 1, minHeight: 44, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.sheet, color: colors.ink },
  inlineButton: { width: 64, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  inlineButtonText: { color: colors.onLife, fontSize: 10, fontWeight: '700' },
  privacyCard: { marginTop: spacing.xl, padding: spacing.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  privacyCardHeader: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  dangerZone: { marginTop: spacing.lg, padding: spacing.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.dangerLine, borderRadius: 6, backgroundColor: colors.dangerLight },
  ...
  deleteButton: { minHeight: 48, marginTop: spacing.lg, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.dangerLine, borderRadius: 6, backgroundColor: colors.paper },
