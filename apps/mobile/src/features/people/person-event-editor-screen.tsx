...
const styles = createThemedStyles(() => ({
  ...
  formCard: { marginTop: spacing.lg, paddingHorizontal: spacing.lg, paddingBottom: spacing.sm, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  input: { minHeight: 50, marginTop: spacing.sm, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 13 },
  ...
  participantCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  saveButton: { minHeight: 54, marginTop: spacing.xl, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
