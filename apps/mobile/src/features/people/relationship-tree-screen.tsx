          ...
          <>
            <View style={styles.memberIdentity}>
              ...
              <View style={styles.memberIdentityCopy}>
                {selectedMember.person ? <StyledName numberOfLines={1} style={styles.memberName} value={memberDisplayName(selectedMember, preferences)} variant={preferences.friendNameStyle} /> : <Text numberOfLines={1} style={styles.memberName}>{memberDisplayName(selectedMember, preferences)}</Text>}
...
const styles = createThemedStyles(() => ({
  ...
  directRelations: { marginTop: spacing.lg, overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.paper },
  ...
  primaryAction: { minHeight: 50, marginTop: spacing.lg, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderRadius: 6, backgroundColor: colors.life },
  ...
  secondaryAction: { minHeight: 44, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6 },
  ...
  relationshipPreview: { minHeight: 50, marginTop: spacing.lg, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  kindOption: { minWidth: '31%', minHeight: 42, paddingHorizontal: spacing.sm, flexGrow: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  targetModeControl: { padding: 4, flexDirection: 'row', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.paper },
  targetModeOption: { minHeight: 40, flex: 1, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
  ...
  placeholderNotice: { minHeight: 74, marginTop: spacing.md, padding: spacing.md, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderStyle: 'dashed', borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  targetList: { overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  saveButton: { minHeight: 52, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
