...
const styles = createThemedStyles(() => ({
  ...
  secondaryAction: { minWidth: 128, minHeight: 46, marginTop: spacing.lg, alignItems: 'center', justifyContent: 'center', borderWidth: StyleSheet.hairlineWidth, borderRadius: 6 },
  ...
  sheetInput: { minHeight: 52, marginTop: spacing.lg, paddingHorizontal: spacing.md, borderRadius: 6, fontFamily: typography.mono, fontSize: 16 },
  fontSearchInput: { minHeight: 48, marginTop: spacing.sm, paddingHorizontal: spacing.md, borderRadius: 6, fontSize: 13 },
  ...
  primaryAction: { minHeight: 48, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
  ...
  excerptPanel: { flex: 1 },
  excerptInput: { minHeight: 96, maxHeight: 150, marginTop: spacing.md, padding: spacing.md, borderRadius: 6, fontSize: 13, lineHeight: 21 },
  ...
  themeOption: { flex: 1, minWidth: 0, minHeight: 42, paddingHorizontal: spacing.xs, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, borderWidth: StyleSheet.hairlineWidth, borderRadius: 6 },
  ...
  fontSettingButton: { minHeight: 38, paddingHorizontal: spacing.sm, flexDirection: 'row', alignItems: 'center', borderRadius: 6 },
  fontSettingValue: { flex: 1, minWidth: 0, marginRight: spacing.xs, fontSize: 10, fontWeight: '600', textAlign: 'right' },
  stepper: { minHeight: 38, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 6 },
  ...
  segmented: { minHeight: 38, padding: 2, flexDirection: 'row', borderRadius: 6 },
  segment: { flex: 1, minWidth: 0, minHeight: 34, paddingHorizontal: spacing.xs, alignItems: 'center', justifyContent: 'center', borderRadius: 6 },
