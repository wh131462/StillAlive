...
const styles = createThemedStyles(() => ({
  ...
  importProgress: { minHeight: 64, marginTop: spacing.md, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  continueCard: { minHeight: 146, padding: spacing.md, flexDirection: 'row', alignItems: 'center', borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  bookListEmpty: { minHeight: 66, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  searchBar: { flex: 1, minHeight: 46, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lineSoft, borderRadius: 6, backgroundColor: colors.sheet },
  ...
  sortButton: { minHeight: 46, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', gap: 5, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.lifeLine, borderRadius: 6, backgroundColor: colors.lifeLight },
  ...
  empty: { marginTop: spacing.xl, padding: spacing.xl, alignItems: 'center', borderRadius: 6, backgroundColor: colors.sheet },
  ...
  emptyButton: { minHeight: 44, marginTop: spacing.lg, paddingHorizontal: spacing.lg, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
  ...
  sheetCancel: { minHeight: 48, marginTop: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.paper },
  ...
  editInput: { minHeight: 50, paddingHorizontal: spacing.md, borderRadius: 6, backgroundColor: colors.paper, color: colors.ink, fontSize: 14 },
  ...
  saveButton: { minHeight: 50, marginTop: spacing.xl, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: colors.life },
